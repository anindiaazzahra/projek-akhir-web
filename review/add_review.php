...
if (isset($_POST['submit'])) {
  if (post_review($_POST) > 0 && put_rating_resto($id_resto) > 0) {
    ...
    <div class="container">
      <form action="" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" id="inputJudul" name="judul" placeholder="Tulis judul dari review kamu di sini..." aria-label="judul input" required>
        </div>
        <div class="mb-3">
          <label for="inputDeskripsi" class="form-label">Deskripsi</label>
          <textarea id="inputDeskripsi" name="deskripsi" rows="7" placeholder="Tulis detail rasa, suasana, pelayanan dari kunjungan kamu di sini..." aria-label="deskripsi input" required></textarea>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              <label for="inputTanggal" class="form-label">Tanggal</label>
              <input type="date" id="inputTanggal" name="tanggal" aria-label="tanggal input" required>
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3 rating">
              <label for="inputRating">Rating</label>
              <input type="number" min="1" max="5" id="inputRating" name="rating" placeholder="Tulis rate 1-5" aria-label="rating input" required>
            </div>
          </div>
        </div>
